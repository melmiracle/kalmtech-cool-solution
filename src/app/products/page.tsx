          ...
          <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-6">
            {itProducts.map((item) => (
              ...
              >
                ...
                <div className="w-full h-40 bg-indigo-50 rounded-xl flex items-center justify-center text-5xl mb-4 group-hover:bg-indigo-100 transition-colors">
                  {item.icon}
                </div>
        ...
        <div>
          ...
          <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-6">
            {airconProducts.map((item) => (
              ...
              >
                {/* Image placeholder — replace with <Image> when photos are ready */}
                <div className="w-full h-40 bg-blue-50 rounded-xl flex items-center justify-center text-5xl mb-4 group-hover:bg-blue-100 transition-colors">
                  {item.icon}
                </div>
                <h3 className="text-lg font-bold text-gray-900 mb-2">{item.title}</h3>
                <p className="text-sm text-gray-600 leading-relaxed">{item.description}</p>
